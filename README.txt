...
Опционально: Напишите тесты на phpunit проверяющие поведение фигур на поле. Ожидается соответствие кода PSR, подключение сторонних пакетов через composer.
